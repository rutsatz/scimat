...
import es.ugr.scimat.gui.commands.edit.globalreplace.GlobalReplaceReferenceSourceGroupsEdit;
 ...
 * @author mjcobo
 */
public class GlobalReplaceReferenceSourceGroupPanel extends GlobalReplaceSelectFieldsPanel {

  /** Creates new form GlobalReplaceAffiliationPanel */
  public GlobalReplaceReferenceSourceGroupPanel() {
    initComponents();
  }
  ...
  public void doGlobalReplaceAction(String find, String replace) {
    ...
    new PerformKnowledgeBaseEditTask(new GlobalReplaceReferenceSourceGroupsEdit(find,
            replace, 
