...
import es.ugr.scimat.gui.commands.edit.add.AddWordGroupEdit;
 ...
 * @author mjcobo
 */
public class AddWordGroupDialog extends javax.swing.JDialog {

    /**
     * Creates new form AddDocumentDialog
     */
    public AddWordGroupDialog(java.awt.Frame parent) {
        super(parent, true);
        initComponents();
    }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        if (this.groupNameTextField.getText().isEmpty()) {
            ...
            task = new PerformKnowledgeBaseEditTask(new AddWordGroupEdit(this.groupNameTextField.getText(),
