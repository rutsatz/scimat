...
import es.ugr.scimat.gui.commands.edit.globalreplace.GlobalReplaceSubjectCategoriesEdit;
import es.ugr.scimat.gui.commands.task.PerformKnowledgeBaseEditTask;

/**
 * @author mjcobo
 */
public class GlobalReplaceSubjectCategoryPanel extends GlobalReplaceSelectFieldsPanel {

    /**
     * Creates new form GlobalReplaceAffiliationPanel
     */
    public GlobalReplaceSubjectCategoryPanel() {
        initComponents();
    }
    ...
    public void doGlobalReplaceAction(String find, String replace) {
        ...
        new PerformKnowledgeBaseEditTask(new GlobalReplaceSubjectCategoriesEdit(find,
                replace,
                this.nameCheckBox.isSelected()),
                this).execute();
    }
