...
import es.ugr.scimat.api.analysis.network.labeller.*;
...
import es.ugr.scimat.api.analysis.performance.docmapper.*;
import es.ugr.scimat.api.analysis.performance.quality.*;
import es.ugr.scimat.api.analysis.performance.quantity.DocumentCountAggregationMeasure;
import es.ugr.scimat.api.analysis.temporal.*;
...
import es.ugr.scimat.api.dataset.datasetbuilder.*;
...
import es.ugr.scimat.api.mapping.clustering.*;
...
import es.ugr.scimat.api.similaritymeasure.direct.*;
