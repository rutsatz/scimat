 ...
 * @author mjcobo
 */
public class EditReferenceGroupDialog extends javax.swing.JDialog {

    /**
     * Creates new form AddDocumentDialog
     */
    public EditReferenceGroupDialog(java.awt.Frame parent) {
        super(parent, true);
        initComponents();
    }
     ...
     *
     */
    public void refreshData(ReferenceGroup referenceGroup) {
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        if (this.groupNameTextField.getText().isEmpty()) {
            ...
            task = new PerformKnowledgeBaseEditTask(new UpdateReferenceGroupEdit(this.referenceGroup.getReferenceGroupID(), this.groupNameTextField.getText(),
