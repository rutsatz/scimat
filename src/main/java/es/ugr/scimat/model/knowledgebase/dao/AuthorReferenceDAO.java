...
import es.ugr.scimat.knowledgebaseevents.event.add.AddAuthorReferenceEvent;
import es.ugr.scimat.knowledgebaseevents.event.add.AddAuthorReferenceWithoutGroupEvent;
import es.ugr.scimat.knowledgebaseevents.event.relation.AuthorReferenceGroupRelationAuthorReferenceEvent;
import es.ugr.scimat.knowledgebaseevents.event.relation.AuthorRelationAuthorReferenceEvent;
import es.ugr.scimat.knowledgebaseevents.event.relation.ReferenceRelationAuthorReferenceEvent;
import es.ugr.scimat.knowledgebaseevents.event.remove.RemoveAuthorReferenceEvent;
import es.ugr.scimat.knowledgebaseevents.event.remove.RemoveAuthorReferenceWithoutGroupEvent;
