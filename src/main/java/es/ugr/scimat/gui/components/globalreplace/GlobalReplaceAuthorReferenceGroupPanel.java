...
import es.ugr.scimat.gui.commands.edit.globalreplace.GlobalReplaceAuthorReferenceGroupsEdit;
import es.ugr.scimat.gui.commands.task.PerformKnowledgeBaseEditTask;

/**
 * @author mjcobo
 */
public class GlobalReplaceAuthorReferenceGroupPanel extends GlobalReplaceSelectFieldsPanel {

    /**
     * Creates new form GlobalReplaceAffiliationPanel
     */
    public GlobalReplaceAuthorReferenceGroupPanel() {
        initComponents();
    }
    ...
    public void doGlobalReplaceAction(String find, String replace) {
        ...
        new PerformKnowledgeBaseEditTask(new GlobalReplaceAuthorReferenceGroupsEdit(find,
                replace,
