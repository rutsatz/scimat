...
import es.ugr.scimat.gui.commands.edit.add.AddWordEdit;
...
public class AddWordDialog extends javax.swing.JDialog {
     ...
     */
    public AddWordDialog(java.awt.Frame parent) {
        super(parent, true);
        initComponents();
    }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        if (this.nameTextField.getText().isEmpty()) {
            ...
            task = new PerformKnowledgeBaseEditTask(new AddWordEdit(this.nameTextField.getText()), rootPane);
