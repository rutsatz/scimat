 ...
 */
public class ReferenceGroupDetailPanel extends GenericDetailPanel<ReferenceGroup> {

    /**
     * Creates new form WordGroupDetailPanel
     */
    public ReferenceGroupDetailPanel() {
        initComponents();
     ...
     */
    public void refreshItem(ReferenceGroup referenceGroup) {

        this.referenceGroup = referenceGroup;

        if (referenceGroup != null) {

            idTextField.setText(this.referenceGroup.getReferenceGroupID().toString());
            stopGroupCheckBox.setSelected(this.referenceGroup.isStopGroup());
            nameTextField.setText(this.referenceGroup.getGroupName());
