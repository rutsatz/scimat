...
import es.ugr.scimat.gui.commands.edit.globalreplace.GlobalReplaceAuthorGroupsEdit;
...
public class GlobalReplaceAuthorGroupPanel extends GlobalReplaceSelectFieldsPanel {
  ...
  public void doGlobalReplaceAction(String find, String replace) {
    ...
    new PerformKnowledgeBaseEditTask(new GlobalReplaceAuthorGroupsEdit(find, 
            replace, 
