 ...
 * @author mjcobo
 */
public class EditReferenceSourceGroupDialog extends javax.swing.JDialog {

  /** Creates new form AddDocumentDialog */
  public EditReferenceSourceGroupDialog(java.awt.Frame parent) {
    super(parent, true);
    initComponents();
  }
   ...
   *
   */
  public void refreshData(ReferenceSourceGroup referenceSourceGroup) {
  ...
  private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
    ...
    if (this.groupNameTextField.getText().isEmpty()) {
      ...
      task = new PerformKnowledgeBaseEditTask(new UpdateReferenceSourceGroupEdit(this.referenceSourceGroup.getReferenceSourceGroupID(), this.groupNameTextField.getText(),
