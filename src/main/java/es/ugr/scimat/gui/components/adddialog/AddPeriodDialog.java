...
import es.ugr.scimat.gui.commands.edit.add.AddPeriodEdit;
 ...
 * @author mjcobo
 */
public class AddPeriodDialog extends javax.swing.JDialog {

    /**
     * Creates new form AddDocumentDialog
     */
    public AddPeriodDialog(java.awt.Frame parent) {
        super(parent, true);
        initComponents();
    }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        if (this.nameTextField.getText().isEmpty()) {
            ...
            task = new PerformKnowledgeBaseEditTask(new AddPeriodEdit(this.nameTextField.getText()),
                    rootPane);
