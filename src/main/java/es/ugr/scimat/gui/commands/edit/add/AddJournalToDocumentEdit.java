 ...
 * @author mjcobo
 */
public class AddJournalToDocumentEdit extends KnowledgeBaseEdit {
    ...
    public boolean execute() throws KnowledgeBaseException {
        ...
        try {
            ...
            if (this.journal != null) {
                ...
                documentDAO.setJournal(document.getDocumentID(), this.journal.getJournalID(), true);
    ...
    public void undo() throws CannotUndoException {
        ...
        try {
            ...
            if (this.oldJournal != null) {
                ...
                documentDAO.setJournal(document.getDocumentID(),
                        this.oldJournal.getJournalID(), true);
    ...
    public void redo() throws CannotUndoException {
        ...
        try {
            ...
            if (this.journal != null) {
                ...
                documentDAO.setJournal(document.getDocumentID(),
                        this.journal.getJournalID(), true);
