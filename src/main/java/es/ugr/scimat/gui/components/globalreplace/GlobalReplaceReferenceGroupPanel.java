...
import es.ugr.scimat.gui.commands.edit.globalreplace.GlobalReplaceReferenceGroupsEdit;
 ...
 * @author mjcobo
 */
public class GlobalReplaceReferenceGroupPanel extends GlobalReplaceSelectFieldsPanel {

  /** Creates new form GlobalReplaceAffiliationPanel */
  public GlobalReplaceReferenceGroupPanel() {
    initComponents();
  }
  ...
  public void doGlobalReplaceAction(String find, String replace) {
    ...
    new PerformKnowledgeBaseEditTask(new GlobalReplaceReferenceGroupsEdit(find, 
            replace, 
