...
import es.ugr.scimat.gui.commands.task.MakeAdvancedReportHTMLTask;
import es.ugr.scimat.gui.commands.task.MakeAdvancedReportLaTeXTask;
import es.ugr.scimat.gui.commands.task.MakeReportHTMLTask;
import es.ugr.scimat.gui.commands.task.MakeReportLaTeXTask;
...
public class AnalysisViewDialog extends javax.swing.JDialog {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        longitudinalResultPanel = new LongitudinalResultPanel();
        resultsByPeriodPanel = new ResultsByPeriodPanel();
