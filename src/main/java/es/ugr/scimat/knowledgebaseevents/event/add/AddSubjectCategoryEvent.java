 ...
 * @author mjcobo
 */
public class AddSubjectCategoryEvent implements KnowledgeBaseEvent {
     ...
     */
    public AddSubjectCategoryEvent(ArrayList<SubjectCategory> subjectCategories) {
     ...
     * @param subjectCategories
     */
    public AddSubjectCategoryEvent(SubjectCategory subjectCategory) {
    ...
    public void fireEvent() throws KnowledgeBaseException {
        ...
        CurrentProject.getInstance().getKbObserver().fireSubjectCategoryAdded(subjectCategories);
    }
