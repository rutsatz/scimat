...
import es.ugr.scimat.analysis.AnalysisConfiguration;
import es.ugr.scimat.analysis.KeyProperties;
import es.ugr.scimat.analysis.KindOfMatrixEnum;
...
import es.ugr.scimat.gui.components.tablemodel.ClusterPropertiesTableModel;
import es.ugr.scimat.gui.components.tablemodel.ClusterTableModel;
import es.ugr.scimat.gui.components.tablemodel.NodeTableModel;
import es.ugr.scimat.gui.components.tablemodel.PerformanceMeasuresAvailableTableModel;
import es.ugr.scimat.gui.components.tablemodel.PeriodsInAnalysisTableModel;
...
public class ResultsByPeriodPanel extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    strategicDiagramPanel = new StrategicDiagramPanel();
    clusterNetworkPanel = new ClusterNetworkPanel();
