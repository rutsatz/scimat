 ...
 */
public class AuthorReferenceGroupDetailPanel extends GenericDetailPanel<AuthorReferenceGroup> {

  /** 
   * Creates new form WordGroupDetailPanel
   */
  public AuthorReferenceGroupDetailPanel() {
    initComponents();
   ...
   */
  public void refreshItem(AuthorReferenceGroup authorReferenceGroup) {

    this.authorReferenceGroup = authorReferenceGroup;

    if (authorReferenceGroup != null) {

      idTextField.setText(this.authorReferenceGroup.getAuthorReferenceGroupID().toString());
      stopGroupCheckBox.setSelected(this.authorReferenceGroup.isStopGroup());
      nameTextField.setText(this.authorReferenceGroup.getGroupName());
