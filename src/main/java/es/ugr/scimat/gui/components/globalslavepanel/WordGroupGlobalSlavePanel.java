...
import es.ugr.scimat.gui.components.detailspanel.WordGroupDetailPanel;
...
public class WordGroupGlobalSlavePanel extends GlobalSlavePanel<WordGroup> {
    ...
    private void initComponents() {
        ...
        wordGroupDetailPanel = new WordGroupDetailPanel();
        hideAndShowWordPanel = new HideAndShowPanel();
        wordInfoPanel = new javax.swing.JPanel();
        wordGroupSlaveWordsPanel = new WordGroupSlaveWordsPanel();
