...
import es.ugr.scimat.gui.components.slavepanel.JournalSlaveDocumentsPanel;
import es.ugr.scimat.gui.components.slavepanel.JournalSlaveJournalSubjectCategoryPublishDatePanel;
...
public class JournalGlobalSlavePanel extends GlobalSlavePanel<Journal> {
  ...
  private void initComponents() {
    ...
    journalDetailPanel = new JournalDetailPanel();
    hideAndShowDocumentPanel = new HideAndShowPanel();
    documentInfoPanel = new javax.swing.JPanel();
    journalSlaveDocumentsPanel = new JournalSlaveDocumentsPanel();
    hideAndShowSubjectCategoryPanel = new HideAndShowPanel();
    subjectCategoryPanel = new javax.swing.JPanel();
    journalSlaveJournalSubjectCategoryPublishDatePanel = new JournalSlaveJournalSubjectCategoryPublishDatePanel();
