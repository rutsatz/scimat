...
import es.ugr.scimat.gui.commands.edit.globalreplace.GlobalReplacePeriodsEdit;
 ...
 * @author mjcobo
 */
public class GlobalReplacePeriodPanel extends GlobalReplaceSelectFieldsPanel {

  /** Creates new form GlobalReplaceAffiliationPanel */
  public GlobalReplacePeriodPanel() {
    initComponents();
  }
  ...
  public void doGlobalReplaceAction(String find, String replace) {
    ...
    new PerformKnowledgeBaseEditTask(new GlobalReplacePeriodsEdit(find,
            replace, 
