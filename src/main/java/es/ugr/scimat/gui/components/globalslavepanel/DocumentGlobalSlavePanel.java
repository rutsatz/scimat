...
import es.ugr.scimat.gui.components.SelectionObserverButton;
import es.ugr.scimat.gui.components.SlaveItemObserverButton;
import es.ugr.scimat.gui.components.adddialog.AddDialogManager;
import es.ugr.scimat.gui.components.detailspanel.DocumentDetailPanel;
import es.ugr.scimat.gui.components.editdialog.EditDialogManager;
import es.ugr.scimat.gui.components.slavepanel.*;
import es.ugr.scimat.gui.commands.edit.delete.DeleteAffiliationsFromDocumentEdit;
import es.ugr.scimat.gui.commands.edit.delete.DeleteAuthorsFromDocumentEdit;
import es.ugr.scimat.gui.commands.edit.delete.DeleteJournalFromDocumentEdit;
import es.ugr.scimat.gui.commands.edit.delete.DeletePublishDateFromDocumentEdit;
import es.ugr.scimat.gui.commands.edit.delete.DeleteReferencesFromDocumentEdit;
import es.ugr.scimat.gui.commands.edit.delete.DeleteWordsFromDocumentEdit;
...
public class DocumentGlobalSlavePanel extends GlobalSlavePanel<Document> {
  ...
  private void initComponents() {
    ...
    documentDetailPanel = new DocumentDetailPanel();
    ...
    documentSlaveJournalPanel = new DocumentSlaveJournalPanel();
    addJournalButton = new javax.swing.JButton();
    deleteJournalButton = new SlaveItemObserverButton();
    hideAndShowPublishDatePanel = new HideAndShowPanel();
    publishDateInfoPanel = new javax.swing.JPanel();
    documentSlavePublishDatePanel = new DocumentSlavePublishDatePanel();
    addPublishDateButton = new javax.swing.JButton();
    deletePublishDateButton = new SlaveItemObserverButton();
    hideAndShowAffiliationPanel = new HideAndShowPanel();
    affiliationsInfoPanel = new javax.swing.JPanel();
    documentSlaveAffiliationsPanel = new DocumentSlaveAffiliationsPanel();
    ...
    documentSlaveAuthorsPanel = new DocumentSlaveAuthorsPanel();
    ...
    documentSlaveWordsPanel = new DocumentSlaveWordsPanel();
    ...
    documentSlaveReferencesPanel = new DocumentSlaveReferencesPanel();
