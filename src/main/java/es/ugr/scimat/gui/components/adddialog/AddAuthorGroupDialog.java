...
import es.ugr.scimat.gui.commands.edit.add.AddAuthorGroupEdit;
 ...
 * @author mjcobo
 */
public class AddAuthorGroupDialog extends javax.swing.JDialog {

  /** Creates new form AddDocumentDialog */
  public AddAuthorGroupDialog(java.awt.Frame parent) {
    super(parent, true);
    initComponents();
  }
  ...
  private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
    ...
    if (this.groupNameTextField.getText().isEmpty()) {
      ...
      task = new PerformKnowledgeBaseEditTask(new AddAuthorGroupEdit(this.groupNameTextField.getText(),
