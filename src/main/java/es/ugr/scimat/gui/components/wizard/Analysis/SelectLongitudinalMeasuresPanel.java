...
import es.ugr.scimat.analysis.SimilarityMeasuresEnum;
...
public class SelectLongitudinalMeasuresPanel extends GenericWizardStepPanel {
    ...
    private void initComponents() {
        ...
        evolutionMapMeasuresPanel = new SelectSimilarityMeasurePanel();
        overlappingMapMeasuresPanel = new SelectSimilarityMeasurePanel();
