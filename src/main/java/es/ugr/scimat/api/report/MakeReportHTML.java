 ...
 * @author mjcobo
 */
public class MakeReportHTML implements ReportGenericBuilder {
...
//    PrintStream out = new PrintStream(getFileAbsolutePathMainHTMLPage(), StandardCharsets.UTF_8.name());
    ...
    switch (this.globalExperimentResult.getAnalysisConfiguration().getUnitOfAnalysis()) {
      ...
      case Authors: out.print("Authors");
        break;
        
      case Words: out.print("Words (authorRole=" + 
      ...
      case References: out.print("References");
        break;
        
      case AuthorsReference: out.print("Author-References");
        break;
        
      case ReferenceSources: out.print("Source-References");
        break;
    }
    ...
    switch (this.globalExperimentResult.getAnalysisConfiguration().getKindOfMatrix()) {
      ...
      case CoOccurrence: out.print("Co-occurence");
        break;
        
      case BasicCoupling: out.print("Basic coupling");
        break;
        
      case AggregatedCouplingBasedOnAuthor: out.print("Aggregated coupling based on author");
        break;
        
      case AggregatedCouplingBasedOnJournal: out.print("Aggregated coupling base on journal");
        break;
    }
    ...
    switch (this.globalExperimentResult.getAnalysisConfiguration().getNormalizationMeasure()) {
      ...
      case AssociationStrength: out.print("Association strength");
        break;
        
      case EquivalenceIndex: out.print("Equivalence index");
        break;
        
      case InclusionIndex: out.print("Inclusion index");
        break;
        
      case JaccardIndex: out.print("Jaccard index");
        break;
      
      case SaltonCosine: out.print("Salton cosine");
        break;
    }
  ...
  private void doPeriodHTLMPage(String escapedPeriodName, int periodPosition, AnalysisPeriodResult results)
    throws FileNotFoundException, IOException, TranscoderException {
