...
import es.ugr.scimat.gui.components.detailspanel.AuthorDetailPanel;
import es.ugr.scimat.gui.components.slavepanel.AuthorSlaveAffiliationsPanel;
import es.ugr.scimat.gui.components.slavepanel.AuthorSlaveAuthorGroupPanel;
import es.ugr.scimat.gui.components.slavepanel.AuthorSlaveDocumentsPanel;
...
public class AuthorGlobalSlavePanel extends GlobalSlavePanel<Author> {
  ...
  private void initComponents() {
    ...
    authorDetailPanel = new AuthorDetailPanel();
    updateAuthorButton = new javax.swing.JButton();
    hideAndShowAuthorGroupPanel = new HideAndShowPanel();
    authorGroupInfoPanel = new javax.swing.JPanel();
    authorSlaveAuthorGroupPanel = new AuthorSlaveAuthorGroupPanel();
    hideAndShowAffiliationPanel = new HideAndShowPanel();
    affiliationInfoPanel = new javax.swing.JPanel();
    authorSlaveAffiliationsPanel = new AuthorSlaveAffiliationsPanel();
    hideAndShowDocumentPanel = new HideAndShowPanel();
    documentInfoPanel = new javax.swing.JPanel();
    authorSlaveDocumentsPanel = new AuthorSlaveDocumentsPanel();
