/*
 * DeletePublishDateFromDocumentEdit.java
 *
 ...
 * @author mjcobo
 */
public class DeletePublishDateFromDocumentEdit extends KnowledgeBaseEdit {
     ...
     * @param document
     */
    public DeletePublishDateFromDocumentEdit(Document document) {
    ...
    public void undo() throws CannotUndoException {
        ...
        try {
            ...
            if (this.oldPublishDate != null) {
                ...
                documentDAO.setPublishDate(document.getDocumentID(),
                        this.oldPublishDate.getPublishDateID(), true);
