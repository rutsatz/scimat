...
import es.ugr.scimat.knowledgebaseevents.event.add.AddAuthorEvent;
import es.ugr.scimat.knowledgebaseevents.event.add.AddAuthorWithoutGroupEvent;
import es.ugr.scimat.knowledgebaseevents.event.relation.AuthorGroupRelationAuthorEvent;
import es.ugr.scimat.knowledgebaseevents.event.relation.AuthorRelationAffiliationEvent;
import es.ugr.scimat.knowledgebaseevents.event.relation.DocumentRelationAuthorEvent;
import es.ugr.scimat.knowledgebaseevents.event.remove.RemoveAuthorEvent;
import es.ugr.scimat.knowledgebaseevents.event.remove.RemoveAuthorWithoutGroupEvent;
