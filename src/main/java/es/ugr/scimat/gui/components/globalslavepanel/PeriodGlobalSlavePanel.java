...
import es.ugr.scimat.gui.commands.edit.delete.DeletePublishDatesFromPeriodEdit;
...
import es.ugr.scimat.gui.components.detailspanel.PeriodDetailPanel;
import es.ugr.scimat.gui.components.slavepanel.PeriodSlavePublishDatesPanel;
...
public class PeriodGlobalSlavePanel extends GlobalSlavePanel<Period> {
  ...
  private void initComponents() {
    ...
    periodDetailPanel = new PeriodDetailPanel();
    hideAndShowPublishDatePanel = new HideAndShowPanel();
    publishDateInfoPanel = new javax.swing.JPanel();
    periodSlavePublishDatesPanel = new PeriodSlavePublishDatesPanel();
