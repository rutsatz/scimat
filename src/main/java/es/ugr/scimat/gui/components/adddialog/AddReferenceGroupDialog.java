...
import es.ugr.scimat.gui.commands.edit.add.AddReferenceGroupEdit;
 ...
 * @author mjcobo
 */
public class AddReferenceGroupDialog extends javax.swing.JDialog {

  /** Creates new form AddDocumentDialog */
  public AddReferenceGroupDialog(java.awt.Frame parent) {
    super(parent, true);
    initComponents();
  }
  ...
  private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
    ...
    if (this.groupNameTextField.getText().isEmpty()) {
      ...
      task = new PerformKnowledgeBaseEditTask(new AddReferenceGroupEdit(this.groupNameTextField.getText(),
