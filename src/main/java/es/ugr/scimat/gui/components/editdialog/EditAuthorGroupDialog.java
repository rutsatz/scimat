 ...
 * @author mjcobo
 */
public class EditAuthorGroupDialog extends javax.swing.JDialog {

    /**
     * Creates new form AddDocumentDialog
     */
    public EditAuthorGroupDialog(java.awt.Frame parent) {
        super(parent, true);
        initComponents();
    }
     ...
     *
     */
    public void refreshData(AuthorGroup authorGroup) {
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        if (this.groupNameTextField.getText().isEmpty()) {
            ...
            task = new PerformKnowledgeBaseEditTask(new UpdateAuthorGroupEdit(this.authorGroup.getAuthorGroupID(), this.groupNameTextField.getText(),
