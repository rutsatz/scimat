 ...
 * @author mjcobo
 */
public class EditAuthorReferenceGroupDialog extends javax.swing.JDialog {

    /**
     * Creates new form AddDocumentDialog
     */
    public EditAuthorReferenceGroupDialog(java.awt.Frame parent) {
        super(parent, true);
        initComponents();
    }
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        if (this.groupNameTextField.getText().isEmpty()) {
            ...
            task = new PerformKnowledgeBaseEditTask(new UpdateAuthorReferenceGroupEdit(this.authorReferenceGroup.getAuthorReferenceGroupID(), this.groupNameTextField.getText(),
